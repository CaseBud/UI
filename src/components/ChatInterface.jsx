...
import { GiScales, GiPublicSpeaker, GiHandcuffs, GiHouse } from 'react-icons/gi'
...
const ChatInterface = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#0E0E0E] text-white overflow-hidden">
      {
        isResponseScreen ?
          <div className='h-[80vh]'>
            <div className="header pt-[25px] flex items-center justify-between w-full px-8 md:px-[300px]">
              ...
              <button id='newChatBtn' className='bg-[#181818] p-[10px] rounded-[30px] cursor-pointer text-[14px] px-[20px]' onClick={newChat}>New Case</button>
            </div>
          ...
          <div className="middle h-[80vh] flex items-center flex-col justify-center px-4">
            ...
            <div className="boxes mt-[30px] flex items-center gap-2 flex-wrap justify-center">
              <div className="card rounded-lg cursor-pointer transition-all hover:bg-[#201f1f] px-[20px] relative min-h-[20vh] bg-[#181818] p-[10px]">
                <p className='text-[18px]'>What are my rights <br />in a criminal case?</p>
                <i className='absolute right-3 bottom-3 text-[18px]'><GiHandcuffs /></i>
              </div>
              <div className="card rounded-lg cursor-pointer transition-all hover:bg-[#201f1f] px-[20px] relative min-h-[20vh] bg-[#181818] p-[10px]">
                <p className='text-[18px]'>Help with tenant <br />rights and housing <br />laws</p>
                <i className='absolute right-3 bottom-3 text-[18px]'><GiHouse /></i>
              </div>
              <div className="card rounded-lg cursor-pointer transition-all hover:bg-[#201f1f] px-[20px] relative min-h-[20vh] bg-[#181818] p-[10px]">
                <p className='text-[18px]'>Understanding <br />contract terms</p>
                <i className='absolute right-3 bottom-3 text-[18px]'><GiScales /></i>
              </div>
              <div className="card rounded-lg cursor-pointer transition-all hover:bg-[#201f1f] px-[20px] relative min-h-[20vh] bg-[#181818] p-[10px]">
                <p className='text-[18px]'>Legal document <br />analysis help</p>
                <i className='absolute right-3 bottom-3 text-[18px]'><GiPublicSpeaker /></i>
              </div>
            </div>
          </div>
      }
      ...
      <div className="bottom w-full flex flex-col items-center fixed bottom-0 pb-4 bg-[#0E0E0E]">
        ...
        <p className='text-[gray] text-[14px] my-4'>
          CaseBud - Your AI Legal Assistant. Not a substitute for professional legal advice.
        </p>
      </div>
    </div>
  )
