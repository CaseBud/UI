      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col h-full">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-2xl font-bold text-white">CaseBud</h2>
          </div>
          ...
          <div className="mt-auto">
            ...
            <p className="mt-4 text-lg text-blue-100">
              Get started with AI-powered legal assistance and transform your practice today.
            </p>
            <div className="mt-8 grid grid-cols-2 gap-4">
              <div className="bg-blue-900/20 backdrop-blur-sm p-4 rounded-lg">
                <h3 className="text-white font-semibold">Easy Setup</h3>
                <p className="text-blue-100 text-sm mt-1">Start using in minutes</p>
              </div>
              <div className="bg-blue-900/20 backdrop-blur-sm p-4 rounded-lg">
                <h3 className="text-white font-semibold">Secure Platform</h3>
                <p className="text-blue-100 text-sm mt-1">Enterprise-grade security</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-slate-400">Start your journey with CaseBud</p>
          </div>
              ...
              <div>
                <div className="relative">
                  <input
                    ...
                    required
                  />
                  <label className="absolute left-2 -top-2.5 bg-slate-900 px-2 text-sm transition-all
